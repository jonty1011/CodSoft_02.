    ...
    <div className="d-flex flex-column align-items-center w-50 m-auto mt-5"
      ...
      <div className="d-flex justify-content-between align-items-center mb-4 w-100">
        ...
        <div className="input-group flex-grow-1">
          <span className="input-group-text" style={{ backgroundColor: '#ddd' }}>
            <FaSearch />
          </span>
          <input
      ...
      <div className="d-flex flex-column w-100">
        {tasks.map((item) => (
          <div key={item._id} className="m-2 p-2 border w-100 rounded-3 d-flex justify-content-between align-items-center"
               style={{ backgroundColor: '#e6f7ff' }}>
            <span className={item.isDone ? 'text-decoration-line-through' : ''}
                  style={{ color: item.isDone ? '#888' : '#333' }}>
              {item.taskName}
            </span>
